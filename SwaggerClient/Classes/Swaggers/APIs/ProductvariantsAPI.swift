...
public class ProductvariantsAPI: APIBase {
     ...
     */
    public class func getProductvariants(countryCode countryCode: String, productId: String, version: Int, source: String, all: String?, languageCode: String?, currencyCode: String?, completion: ((data: ProductVariantResponse?, error: ErrorType?) -> Void)) {
        getProductvariantsWithRequestBuilder(countryCode: countryCode, productId: productId, version: version, source: source, all: all, languageCode: languageCode, currencyCode: currencyCode).execute { (response, error) -> Void in
    ...
    /**
     ...
     - GET /productvariants/v/{version}/source/{source}/
  ...
  "ProductVariants" : [ {
     ...
     */
    public class func getProductvariantsWithRequestBuilder(countryCode countryCode: String, productId: String, version: Int, source: String, all: String?, languageCode: String?, currencyCode: String?) -> RequestBuilder<ProductVariantResponse> {
        var path = "/productvariants/v/{version}/source/{source}/"
        ...
        let requestBuilder: RequestBuilder<ProductVariantResponse>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
