...
public class PreconfiguredproductsAPI: APIBase {
    ...
    /**
     ...
     - POST /preconfiguredproducts/v/{version}/source/{source}/
    ...
    public class func createPreconfiguredproductsWithRequestBuilder(preconfiguredProductInsert preconfiguredProductInsert: PreconfiguredProductInsert, version: Int, source: String) -> RequestBuilder<PreconfiguredProductsInsertResponse> {
        var path = "/preconfiguredproducts/v/{version}/source/{source}/"
        ...
        let requestBuilder: RequestBuilder<PreconfiguredProductsInsertResponse>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - DELETE /preconfiguredproducts/v/{version}/source/{source}/
    ...
    /**
     ...
     - GET /preconfiguredproducts/v/{version}/source/{source}/
  ...
  "PreconfiguredProducts" : [ {
    ...
    public class func getPreconfiguredproductsWithRequestBuilder(countryCode countryCode: String, version: Int, source: String, languageCode: String?, currencyCode: String?) -> RequestBuilder<PreconfiguredProductsResponse> {
        ...
        let requestBuilder: RequestBuilder<PreconfiguredProductsResponse>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - PUT /preconfiguredproducts/v/{version}/source/{source}/
