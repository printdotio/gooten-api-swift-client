...
public class OrdersAPI: APIBase {
    ...
    /**
     ...
     - GET /v/{version}/source/{source}/orders/
  ...
  "DiscountAmount" : ""
    ...
    public class func gETOrdersWithRequestBuilder(id id: String, version: Int, source: String, languageCode: String?) -> RequestBuilder<PostSubmittedOrder> {
        var path = "/v/{version}/source/{source}/orders/"
        ...
        let requestBuilder: RequestBuilder<PostSubmittedOrder>.Type = Gooten.API.ClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - POST /v/{version}/source/{source}/orders/
  ...
  "Id" : "aeiou"
    ...
    public class func pOSTOrdersWithRequestBuilder(order order: PostOrder, version: Int, source: String) -> RequestBuilder<OrderResult> {
        ...
        let requestBuilder: RequestBuilder<OrderResult>.Type = Gooten.API.ClientAPI.requestBuilderFactory.getBuilder()
