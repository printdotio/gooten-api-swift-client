...
public class ProductsAPI: APIBase {
     ...
     */
    public class func getProducts(countryCode countryCode: String, version: Int, source: String, partnerBillingKey: String?, all: String?, languageCode: String?, currencyCode: String?, completion: ((data: ProductList?, error: ErrorType?) -> Void)) {
        getProductsWithRequestBuilder(countryCode: countryCode, version: version, source: source, partnerBillingKey: partnerBillingKey, all: all, languageCode: languageCode, currencyCode: currencyCode).execute { (response, error) -> Void in
    ...
    /**
     ...
     - GET /v/{version}/source/{source}/products/
  ...
  "Products" : [ {
     ...
     */
    public class func getProductsWithRequestBuilder(countryCode countryCode: String, version: Int, source: String, partnerBillingKey: String?, all: String?, languageCode: String?, currencyCode: String?) -> RequestBuilder<ProductList> {
        var path = "/v/{version}/source/{source}/products/"
        ...
        let requestBuilder: RequestBuilder<ProductList>.Type = Gooten.API.ClientAPI.requestBuilderFactory.getBuilder()
